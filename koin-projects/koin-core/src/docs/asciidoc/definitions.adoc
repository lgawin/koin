...
Koin definitions doesn't take into account generics type argument. For example, the module below tries to define 2 definitions of List:
...
To allow you to use the 2 definitions, you will have to differentiate them via their name, or location (module). For example:
